...
Route::prefix('store')->name('storefront.')->group(function () {
    ...
    Route::get('/sandbox/generate-virtual-upi', [\App\Http\Controllers\Storefront\StorefrontController::class, 'generateVirtualUpi'])->name('sandbox.generate_upi');
    Route::post('/sandbox/verify-otp', [\App\Http\Controllers\Storefront\StorefrontController::class, 'verifyPaymentOtp'])->name('sandbox.verify_otp');
});
