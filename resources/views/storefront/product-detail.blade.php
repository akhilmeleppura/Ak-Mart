...
<div class="container py-4">
    ...
    @if(isset($recentlyViewed) && $recentlyViewed->isNotEmpty())
        <div class="mb-5">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="fw-bold mb-0"><i class="bx bx-history text-primary me-2"></i> {{ __('Recently Viewed Products') }}</h4>
            </div>
            <div class="row g-3">
                @foreach($recentlyViewed as $recent)
                    <div class="col-6 col-md-3 col-lg-2">
                        <div class="product-card p-3 h-100 d-flex flex-column justify-content-between bg-white border rounded-4 shadow-xs">
                            <div>
