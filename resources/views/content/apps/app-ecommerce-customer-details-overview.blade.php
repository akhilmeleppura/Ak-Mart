      ...
      <div class="card-body">
        <div class="row justify-content-between mb-4">
          <div
            ...
            <p class="card-text text-white">Upgrade customer to premium membership to access pro features.
            </p>
          </div>
        ...
        <div class="card h-100">
          <div class="card-body">
            <div class="card-icon mb-2">
              <div class="avatar">
                <div class="avatar-initial rounded bg-label-primary"><i class="icon-base bx bx-dollar icon-lg"></i>
                </div>
              </div>
            </div>
            <div class="card-info">
