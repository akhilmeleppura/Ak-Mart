            ...
            <div class="accordion-header d-flex justify-content-between align-items-center flex-wrap flex-sm-nowrap"
              ...
              <div class="d-flex gap-4 p-6 p-sm-0 pt-0 ms-1 ms-sm-0">
                ...
                <button class="btn p-0" data-bs-toggle="dropdown" aria-expanded="false" role="button"><i
                    class="icon-base bx bx-dots-vertical-rounded icon-md text-body"></i></button>
            ...
            <div class="accordion-header d-flex justify-content-between align-items-center flex-wrap flex-sm-nowrap"
              ...
              <div class="d-flex gap-4 p-6 p-sm-0 pt-0 ms-1 ms-sm-0">
                <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#editCCModal"><i
                    class="icon-base bx bx-edit icon-md text-body"></i></a>
                <a href="javascript:void(0);"><i class="icon-base bx bx-trash icon-md text-body"></i></a>
                <button class="btn p-0" data-bs-toggle="dropdown" aria-expanded="false" role="button"><i
                    class="icon-base bx bx-dots-vertical-rounded icon-md text-body"></i></button>
                <ul class="dropdown-menu">
                ...
                <table class="table table-sm table-borderless text-nowrap">
                  ...
                  <tr>
                    ...
                    <td class="fw-medium text-heading d-flex align-items-center gap-2">United States <i
                        class="icon-base fis fi fi-us rounded-circle me-2 icon-sm"> </i></td>
                  </tr>
                  <tr>
                    <td>CVC check</td>
                    <td class="fw-medium text-heading d-flex align-items-center gap-2">
                      Passed <span class="badge bg-label-success rounded-pill p-0"><i
                          class="icon-base bx bx-check icon-xs"></i></span>
                    </td>
                  </tr>
                </table>
              </div>
          ...
          <div class="accordion-item border-top-0">
            <div class="accordion-header d-flex justify-content-between align-items-center flex-wrap flex-sm-nowrap"
              ...
              <a class="accordion-button collapsed" data-bs-toggle="collapse"
                ...
                <span class="accordion-button-information d-flex align-items-center gap-4">
                  <span class="accordion-button-image">
                    <img src="{{ asset('assets/img/icons/payments/visa-cc.png') }}" class="img-fluid w-px-50 h-px-30"
                      alt="visa-card" />
                  </span>
                  <span class="d-flex flex-column">
