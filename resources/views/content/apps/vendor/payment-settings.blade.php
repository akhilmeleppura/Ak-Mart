    ...
    <div class="col-12">
        <div class="card mb-6">
            <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">{{ __('Payment Gateway Connections') }}</h5>
                <span class="text-muted small">{{ __('Configure your own gateway to receive direct payments.') }}</span>
            </div>
            <div class="card-body pt-6">
                ...
                <form action="{{ route('app-vendor-payment-settings-save') }}" method="POST">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <h6 class="mb-0">{{ __('Stripe Integration') }}</h6>
                    </div>
                    <div class="row mb-6">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <h6 class="mb-0">{{ __('PayPal Integration') }}</h6>
                    </div>
                    <div class="row mb-6">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <h6 class="mb-0">{{ __('PhonePe (India) Integration') }}</h6>
                    </div>
                    <div class="row mb-6">
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-label">{{ __('Salt Index') }}</label>
                    ...
                    <div class="mt-6 pt-4 border-top">
                        <button type="submit" class="btn btn-primary px-10">
                            <i class="bx bx-check me-1"></i> {{ __('Update Gateways') }}
                        </button>
                    </div>
                </form>
            </div>
