...
@section('title', 'Visual Store Builder')
    ...
    <div class="col-md-5">
        <div class="card mb-6">
            <div class="card-header border-bottom">
                <h5 class="card-title mb-0">Store Customization</h5>
                <p class="text-muted small mb-0">Customize your store's look and feel.</p>
            </div>
            <div class="card-body pt-6">
                ...
                <form action="{{ route('app-vendor-store-builder-save') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <hr class="my-6">
                    <h6 class="mb-3">Contact & Social</h6>
                    <div class="mb-3">
    ...
    <div class="col-md-7">
        <div class="card mb-6">
            <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-label-info">Store View</span>
            </div>
                ...
                <div id="previewContainer" class="rounded-bottom overflow-hidden border">
                    ...
                    <nav class="p-4 d-flex justify-content-between align-items-center bg-white border-bottom">
                        <div id="previewLogo">
                            ...
                            @else
                                <h4 class="mb-0" style="color: {{ $theme['theme_primary_color'] }}">LOGO</h4>
                            @endif
                        </div>
                    ...
                    <div id="previewHero" class="p-10 text-center text-white" style="background-color: {{ $theme['theme_primary_color'] }}">
                        ...
                        <button class="btn btn-lg px-8 border-0" id="previewBtn" style="background-color: #fff; color: {{ $theme['theme_primary_color'] }}">Shop Now</button>
                    </div>
