  ...
  <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
    ...
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-md-row mb-6 row-gap-2 flex-wrap">
        <li class="nav-item">
          <a class="nav-link" href="{{ url('customers/' . $customer->id . '/overview') }}"><i
        ...
        <div class="mb-4">
          <div class="d-flex w-100 action-icons">
            <input id="defaultInput" class="form-control me-4 phone-number-mask" type="text"
              placeholder="968 945 8832" />
            <a href="javascript:;" class="btn btn-icon" data-bs-target="#enableOTP" data-bs-toggle="modal"><i
                class="icon-base bx bx-edit icon-md text-heading"></i></a>
            <a href="javascript:;" class="btn btn-icon"><i
                class="icon-base bx bx-user-plus icon-md text-heading"></i></a>
          </div>
        </div>
        <p class="mb-0">
          ...
          <tbody>
            <tr>
              <td class="text-truncate text-heading fw-medium"><i
                  class="icon-base bx bxl-windows icon-md text-info me-2"></i>Chrome on Windows</td>
            ...
            <tr>
              <td class="text-truncate text-heading fw-medium"><i
                  class="mb-1 icon-base bx bx-mobile-alt icon-md text-danger me-2"></i>Chrome on iPhone</td>
            ...
            <tr>
              <td class="text-truncate text-heading fw-medium"><i
                  class="mb-1 icon-base bx bxl-android icon-md text-success me-2"></i>Chrome on Android</td>
            ...
            <tr>
              <td class="text-truncate text-heading fw-medium"><i
                  class="mb-1 icon-base bx bxl-apple icon-md text-secondary me-2"></i>Chrome on MacOS</td>
